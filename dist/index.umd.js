(function (global, factory) {
  ...
  (global = global || self, global['stimulus-audio'] = factory(global.Stimulus));
  ...
  let _default = /*#__PURE__*/function (_Controller) {
    ...
    function _default(...args) {
      ...
      _defineProperty(_assertThisInitialized(_this), "unlockAudio", () => {
        document.body.removeEventListener('click', _this.unlockAudio);
        document.body.removeEventListener('touchstart', _this.unlockAudio);

        _this.element['audio'].play().then(() => {}).catch(() => {});
      });
